      ...
      <div className="space-y-8">
        ...
        <div className="space-y-5 border-b pb-8">
          ...
          <div className="space-y-5">
            {[1, 2].map((i) => (
              <div key={i} className="flex items-center justify-between border-b border-border/10 pb-4">
        ...
        <div className="space-y-5 border-b pb-8">
          ...
          <div className="space-y-5">
            {[1, 2].map((i) => (
              <div key={i} className="flex items-center justify-between border-b border-border/10 pb-4 last:border-0 last:pb-0">
                <div className="space-y-2">
